...
import { BuyEnergy } from "@/utils/requests";
interface BuyEnergyNowProps {
    isopen: boolean;
    isClose?: () => void;
    balance?: number;
    energy_level: number;
...
export default function BuyGCEnergyNow({ isopen, isClose, balance, energy_level }: BuyEnergyNowProps) {
