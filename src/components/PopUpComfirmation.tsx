...
export default function PopUpComfirmationTask({ isopen, isClose, id, title, avater, reward, task_url }: PopUpComfirmationProps) {
    ...
    const [btnStatus, setBtnStatus] = useState<"Pending" | "Completed" | "Start Task">("Start Task");
                    ...
                    <div className="claim-content h-[60vh] w-[90%] bg-black border-2 border-main rounded-[10px] flex flex-col items-center justify-evenly p-3 relative text-center">
                        ...
                        {btnStatus === "Completed" || "Pending" ? (
                                ...
                                btnStatus === "Pending" ? (
                                    ...
                                    <div
                                        className="claim-gift-btn w-[100%] bg-orange flex items-center justify-center h-[8vh] bg-main rounded-[10px] flex-evenly" onClick = { isClose }
                                    >
                                        <h4 className="text-light font-semibold">{btnStatus}</h4>
                                    </div>
                                )
