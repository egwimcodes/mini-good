            ...
            isopen && (
                ...
                <div className="absolute top-0 left-0 h-screen w-screen bg-black bg-opacity-50 flex items-center justify-center">
                    <div className="claim-content h-[60vh] w-[90%] bg-black border-2 border-main rounded-[10px] flex flex-col items-center justify-evenly p-3 relative">
                        ...
                        {hasClaimed ? (
                            <Image src="https://ik.imagekit.io/egwimcodes/win.png?updatedAt=1720197419669" className="w-10" width={200} height={200} alt="" />
                        ...
                        <a target='_blank'
                            rel='noopener noreferrer' href={task_url} className="claim-gift-btn w-[100%] bg-orange flex items-center justify-center h-[8vh] bg-main rounded-[10px] flex-evenly" onClick={() => { isClaim === false ? handleTimer() : handleClaim() }}>
